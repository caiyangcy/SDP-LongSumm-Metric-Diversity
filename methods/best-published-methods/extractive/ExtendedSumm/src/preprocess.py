...
if __name__ == '__main__':
    ...
    parser.add_argument("-map_path", default='REPLACE-BY-YOUR-PATH/data/')
    parser.add_argument("-raw_path", default='REPLACE-BY-YOUR-PATH/line_data')
    parser.add_argument("-sect_label_path", default='REPLACE-BY-YOUR-PATH/line_data')
    parser.add_argument("-save_path", default='REPLACE-BY-YOUR-PATH/data/')
    ...
    parser.add_argument('-log_file', default='REPLACE-BY-YOUR-PATH/logs/cnndm.log')
