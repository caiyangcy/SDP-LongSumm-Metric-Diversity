...
def get_datapoints_parallel(data_idx, num_processes, extractive_doc_dir, extractive_summ_dir, abstractive_doc_dir, abstractive_summ_dir, data_type):
    ...
    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/extractive/LongSumm_extractive_withlabels_avail_train.txt','w') as f:
    #         json.dump(ext_train, f)

    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/extractive/LongSumm_extractive_withlabels_avail_eval.txt','w') as f:
    #         json.dump(ext_val, f)


    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/abstractive/LongSumm_abstractive_withlabels_avail_train.txt','w') as f:
    #         json.dump(abs_train, f)
        
    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/abstractive/LongSumm_abstractive_withlabels_avail_eval.txt','w') as f:
    #         json.dump(abs_val, f)
        

    # else:

    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/extractive/LongSumm_extractive_withlabels_test.txt','w') as f:
    #         json.dump(extractive_updated_data, f)

    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/abstractive/LongSumm_abstractive_withlabels_test.txt','w') as f:
    #         json.dump(abstractive_updated_data, f)

    #     with open(f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/abs_ext/LongSumm_withlabels_test.txt','w') as f:
...
def update_format_abstractive(data_idx, paper, section_missing=False, data_type='avail', is_eval=False):
    ...
    if data_type != "test":
        ...
        path = f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/abstractive/{usage_type}/{doc_id}.json'
    else:
        path = f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/abstractive/test/{doc_id}.json'
...
def update_format_extractive(data_idx, paper, data_type, is_eval):
    ...
    if data_type != "test":
        usage_type = "val" if is_eval else "train"
        path = f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/extractive/{usage_type}/{doc_id}.json'
    else:
        path = f'/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/ExtendedSumm/extractive/test/{doc_id}.json'
    with open(path,'w') as f:
        json.dump(extended_summ_format, f)
...
if __name__ == '__main__':
    ...
    for data_idx in range(10):
        ...
        # data_type = "avail"
        # extractive_doc_dir = f"/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/original/extractive/{data_type}/document"
        # extractive_summ_dir = f"/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/original/extractive/{data_type}/summary"

        # abstractive_doc_dir = f"/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/original/abstractive/{data_type}/document"
        # abstractive_summ_dir = f"/home/caiyang/Documents/CSIRO-Data61-Summer/datasets/dataset_multiple_splits/split_{data_idx}/original/abstractive/{data_type}/summary"
