...
class BertData():
    def __init__(self, args):
        ...
        # elif 'bert-large' in args.model_name:
    ...
    def preprocess_single(self, src, tgt, sent_rg_scores=None, sent_labels=None, sent_sections=None,
        ...
        # if len(tgt_subtoken) < self.args.max_tgt_ntokens:
        #     tgt_subtoken += ['[PAD]'] * (self.args.max_tgt_ntokens-len(tgt_subtoken))
...
def _format_to_bert(params):
    ...
    CHUNK_SIZE_CONST=-1
    if model_name == 'bert-base' or model_name == 'scibert' or model_name == 'bert-large':
        bert = BertData(args)
    ...
    for j, data in enumerate(jobs[debug_idx-1:]):
        ...
        if True:
            ...
            # print(f"tkn_len: {tkn_len}")

            if tkn_len > CHUNK_SIZE_CONST or is_test:
                try:
