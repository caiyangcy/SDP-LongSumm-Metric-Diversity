    ...
    def forward(self, x, segs, mask_src, mask_cls, clss):
        if (self.finetune):
            if self.model_name =='bert' or self.model_name =='scibert':
                ...
                output = self.model(x, attention_mask=mask_src, token_type_ids=segs)
...
class AbsSummarizer(nn.Module):
    def __init__(self, args, device, checkpoint=None, bert_from_extractive=None):
        ...
        print("self.vocab_size inside modle builder: ", self.vocab_size)
        print("tgt_embeddings inside model builder: ", tgt_embeddings )
    ...
    def forward(self, src, tgt, segs, clss, mask_src, mask_tgt, mask_cls):
        ...
        print("attn_enc_dec inside modle builder: ", attn_enc_dec.shape )
