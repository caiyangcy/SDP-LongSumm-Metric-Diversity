...
for data_partition_idx in range(10):
    ...
    scores = evaluate_rouge(DGCNN_system, DGCNN_reference)["rougeL_f"]
    ...
    scores = evaluate_rouge(Bigbird_Small_No_system, Bigbird_Small_No_reference)["rougeL_f"]
    ...
    scores = evaluate_rouge(Summaformer_system, Summaformer_reference)["rougeL_f"]
    ...
    scores = evaluate_rouge(BERTSumm_system, BERTSumm_reference)["rougeL_f"]
    ...
    scores = evaluate_rouge(Bart_system, Bart_reference)["rougeL_f"]
